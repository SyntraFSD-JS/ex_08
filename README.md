...
## Oefeningen:
### Oefening 08: Mastermind
#### Doel:
Het doel van de oefening is het programmeren van een 'MasterMind' spel.
- Jullie kunnen het spel spelen door `solution/index.html` te openen in je browser.
(Doe geen moeite, het solution/script.js bestand is onleesbaar gemaakt)
- Bestudeer verder de commentaren in het `script.js` bestand aandachtig.

Vergeet niet regelmatig te `commiten` en let op de correcte indentering van jullie bestand.
